...
email_password = "fwlf cgte kkey nwzs"
...
class ServiceMonitor(object):
    ...
    def send_email(self, subject, message):
        ...
        try:
            ...
            message += f"\nSource Host IP: {ip_address}\nSource Hostname: {hostname}\nHostname IP addresses: {', '.join(ip_addresses)}"
            msg.attach(MIMEText(message, 'plain'))
    ...
    def get_resource_usage(self):
        ...
        try:
            ...
            if not self.is_active():
                self.send_email("Service Stopped Alert", f"The {self.service} service has stopped.")
